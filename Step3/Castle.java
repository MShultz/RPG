...
public class Castle {
	...
	public void checkUserMovement(String userInput) {
		if (userInput.equalsIgnoreCase("Check Inventory") || userInput.equalsIgnoreCase("Inventory")) {
			adventurer.checkInventory();
		}else if (userInput.equalsIgnoreCase("North") || userInput.equalsIgnoreCase("go North")) {
	...
	public void possiblySpawnEnemy() {
		if (rand.nextInt(RAND_BOUND) <= SPAWN_CHANCE) {
			...
			System.out.println("A " + vamp.getBeingName() + " has appeared!");
